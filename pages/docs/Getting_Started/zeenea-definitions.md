...
A use case provides the rationale for an access request, ensuring that the request is both justified and compliant with organizational policies.

You can specify the following attributes for a use case:
