---
title: Data Steward Guide
description: Manage and document catalog items as a Data Steward with responsibilities for data curation and governance.
---

# {% $markdoc.frontmatter.title %}

As a Data Steward of the Zeenea suite, you have specific rights and permissions. Data stewards are responsible for documenting and managing the catalog items assigned to them.
...
- At least one scanner must be installed and connected to your catalog
- The metamodels of your items must be defined
- Responsibilities to be assigned to contacts in the catalog must be defined
- An inventory of the connection(s) for which you are responsible as Data Steward must have been made by an administrator
{% /callout %}
...
The dashboard is the home page of the Data Steward's Zeenea Studio application. Once logged in, you will find on this page the main management indicators of your perimeter.
...
{% callout type="note" %}
For more details on importing items into the catalog, read [Importing "Datasets" or "Visualization" items into Zeenea](../Stewardship/zeenea-editing-items-in-bulk.md)
{% /callout %}
