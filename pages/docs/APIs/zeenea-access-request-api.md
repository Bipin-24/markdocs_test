...
You must include a comment in the request body describing the error. This comment is displayed to both the data owner and the requester in the applications.
For example:
