# Assigning and Removing Curators
...
2. Go to the **PEOPLE** tab.<br />The **CURATOR** section lists all assigned curators.
...
1. In the Studio, open the item's overview or details page.
2. In the **PEOPLE** tab, click the **Assign curator** button in the **CURATOR** section.<br />The **Assign curator** dialog appears.
...
3. Click **Assign curator**.<br />The **Assign curator** dialog appears.
...
> **Note:** You can also use the **File Import** feature to assign curators to multiple items by filling in the **curator** column in the XLSX file. <br />For more information, see [Importing a File in Zeenea](zeenea-studio-import.md).
