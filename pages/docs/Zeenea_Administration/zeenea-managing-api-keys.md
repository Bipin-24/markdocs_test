...
4. Click the **Create API Key** button. 
   A **Create API key** window opens. 
5. In the **Name** field, enter a unique name for your API key. 
   This name helps you identify the key in the interface later.
